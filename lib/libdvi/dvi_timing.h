...
// PIZERO-30 (M4 step 2b): rewrite one data-island period at word offset
// `word_off` in the three per-lane buffers (preamble + guard + TERC4 island).
// Used by the per-vblank-line audio refill.
