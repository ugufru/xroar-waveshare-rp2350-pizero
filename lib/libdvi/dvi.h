...
struct dvi_inst {
	...
	// before that line's DMA list is loaded. Refills + repoints the HDMI audio
	// data-island buffers from the sample ring. Runs in IRQ context on a vblank
	// line (no video DMA competing) -- still keep it short.
